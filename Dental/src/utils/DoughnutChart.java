...
public class DoughnutChart extends PieChart {
    ...
    @Override
    protected void layoutChartChildren(double top, double left, double contentWidth, double contentHight) {
        super.layoutChartChildren(top, left, contentWidth, contentHight);
    ...
    private void updateInnerCircleLayout() {
        ...
        double maxX = Double.MIN_VALUE, maxY = Double.MAX_VALUE;
